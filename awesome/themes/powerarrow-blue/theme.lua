...
theme.fg_focus                                  = "#8BE61A"
theme.fg_urgent                                 = "#b74822"
theme.bg_normal                                 = "#282A30"
...
local temp = lain.widget.temp({
    settings = function()
        widget:set_markup(markup.font(theme.font, " " .. coretemp_now .. "°C | " ..convert_c_f(coretemp_now).. "°F"))
    end
})
--]]
...
theme.weather = lain.widget.weather({
    city_id = 5809844, -- placeholder (Seattle)
    notification_preset = { font = "Mononoki Nerd Font 12", fg = theme.fg_normal },
    weather_na_markup = markup.fontfg(theme.font, "#ffffff", "N/A "),
    settings = function()
        descr = weather_now["weather"][1]["description"]:lower()
        tempC = math.floor(weather_now["main"]["temp"])

        -- Convert to Fahrenheit
        converted_descr = convert_c_f(tempC)
        widget:set_markup(markup.fontfg(theme.font, "#ffffff", descr .. " : " .. tempC .. "°C | " .. converted_descr .. "°F" ))
    end
})
...
theme.fs = lain.widget.fs({
    notification_preset = { fg = theme.fg_normal, bg = theme.bg_normal, font = "Noto Sans Mono Medium 12" },
    settings = function()
   ...
   s.quake = lain.util.quake({ app = "termite", height = 0.50, argname = "--name %s" })
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            -- arrow("#7197E7", "#A77AC4"),
            wibox.container.background(wibox.container.margin(wibox.widget { nil, neticon, net.widget, layout = wibox.layout.align.horizontal }, 3, 3), "#7197E7"),
            arrow("#7197E7", "#F27E08"),
            wibox.container.background(wibox.container.margin(clock, 4, 8), "#F27E08"),
            arrow("#F27E08", "alpha"),
            s.mylayoutbox,
        },
    }
